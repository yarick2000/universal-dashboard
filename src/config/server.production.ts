...
const config: ServerConfig = {
  ...
  envVariables: {
    ...
    AUTH_SECRET: 'REPLACE-WITH-ENCRYPTED-VALUE',
    AUTH_SALT: 'REPLACE-WITH-ENCRYPTED-VALUE',
    GOOGLE_RECAPTCHA_SECRET: 'REPLACE-WITH-ENCRYPTED-VALUE',
    GOOGLE_RECAPTCHA_SITE_KEY: 'REPLACE-WITH-ENCRYPTED-VALUE',
  },
};
